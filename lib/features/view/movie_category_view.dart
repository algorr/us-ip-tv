...
class MovieCategoryView extends StatefulWidget {
  ...
  @override
  State<MovieCategoryView> createState() => _MovieCategoryViewState();
}

class _MovieCategoryViewState extends State<MovieCategoryView> {
